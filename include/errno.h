...
#define ENODATA			43	//No message is available on the STREAM head read queue. [Option End]
...
#define ENOSR			53	//No STREAM resources. [Option End]
#define ENOSTR			54	//Not a STREAM. [Option End]
...
#define ETIME			77	//Stream ioctl() timeout. [Option End]
